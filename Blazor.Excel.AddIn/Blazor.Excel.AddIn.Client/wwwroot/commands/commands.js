 ...
 * @param event
 */
async function insertTextInExcel(event) {
  console.log("In insertTextInExcel");
  ...
  try {
    ...
    console.log("Finish insertTextInExcel");
  }
...
/**
 * Writes the text from the Home Blazor Page to the Excel slide
 * @param {any} event
 */
...
/**
 * Writes the text from the Counter Blazor Page to the Excel slide
 * @param {any} event
 */
 ...
 * The string is then inserted into a Excel slide as a text box.
...
Office.actions.associate("insertTextInExcel", insertTextInExcel);
